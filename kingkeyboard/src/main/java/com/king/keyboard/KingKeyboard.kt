...
open class KingKeyboard {
    ...
    private val keyboardNormalModeChange by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_normal_mode_change
        )
    }
    private val keyboardNormalMore by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_normal_more_symbol
        )
    }
    ...
    private val keyboardLowercaseLetter by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_lowercase_letter_only
        )
    }
    ...
    private val keyboardUppercaseLetter by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_uppercase_letter_only
        )
    }
    ...
    private val keyboardLetterNumber by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_letter_number
        )
    }
    ...
    private val keyboardNumberDecimal by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_number_decimal
        )
    }
    ...
    private val keyboardLicensePlate by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_license_plate
        )
    }
    ...
    private val keyboardLicensePlateNumber by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_license_plate_number
        )
    }
    ...
    private val keyboardLicensePlateMore by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_license_plate_more
        )
    }
    ...
    private val keyboardLicensePlateProvince by lazy {
        Keyboard(
            context,
            R.xml.king_keyboard_license_plate_province
        )
    }
    ...
    private fun keyBack(isBack: Boolean) {
        when (keyboardType) {
            ...
            KeyboardType.LICENSE_PLATE_MORE -> {
                keyboardType =
                    if (isBack) KeyboardType.LICENSE_PLATE else KeyboardType.LICENSE_PLATE_MODE_CHANGE
            }
            KeyboardType.LICENSE_PLATE_PROVINCE -> {
                keyboardType = KeyboardType.LICENSE_PLATE_NUMBER
            }
