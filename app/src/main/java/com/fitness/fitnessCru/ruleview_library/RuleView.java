...
public class RuleView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        bgColor = ta.getColor(R.styleable.RuleView_zjun_bgColor, Color.parseColor("#FF02BD"));
        ...
        indicatorLineColor = ta.getColor(R.styleable.RuleView_zjun_indicatorLineColor, Color.parseColor("#FF02BD"));
        indicatorLineWidth = ta.getDimension(R.styleable.RuleView_zjun_indicatorLineWidth, dp2px(3f));
        indicatorLineLen = ta.getDimension(R.styleable.RuleView_gv_indicatorLineLen, dp2px(45f));
    ...
    private void drawGradation(Canvas canvas) {
        ...
        while (startNum <= rightMaxNum) {
            ...
            if (startNum % perUnitCount == 0) {
                ...
                canvas.drawLine(distance, (getMeasuredHeight() - longGradationLen * 2), distance, longGradationLen + dp2px(15), mPaint);
                ...
                canvas.drawText(text, distance - textWidth * .5f, textSize/*longGradationLen + gradationNumberGap + textSize*/, mTextPaint);
            } else {
                // 短刻度
                mPaint.setStrokeWidth(shortLineWidth);
                canvas.drawLine(distance, (getMeasuredHeight() - shortGradationLen * 2), distance, shortGradationLen + dp2px(15), mPaint);
            }
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        //
        canvas.drawLine(mHalfWidth, textSize + dp2px(1), mHalfWidth, indicatorLineLen, mPaint);
        // 默认形状画笔
