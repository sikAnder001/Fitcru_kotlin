...
import com.fitness.fitnessCru.quickbox.adapters.OpponentsFromCallAdapter
...
import com.fitness.fitnessCru.quickbox.utils.shortToast
...
class VideoConversationFragment : BaseConversationFragment(), Serializable,
    ...
    private var session: QBRTCSession? = null
    ...
    override fun initViews(view: View?) {
        ...
        tvFullNameUser.text = Hawk.get(CNAME)
    }
    ...
    private fun setDuringCallActionBar() {
        ...
        actionBar.setDisplayShowTitleEnabled(false)
        //tvFullNameUser.text = userInfo.get(NAME)
    ...
    private fun switchCamera(item: MenuItem?) {
        ...
        conversationFragmentCallback?.onSwitchCamera(object :
    ...
    private fun updateViewHolders(position: Int) {
        ...
        val childViewHolder =
            recyclerView.getChildViewHolder(childView) as OpponentsFromCallAdapter.ViewHolder
        opponentViewHolders.put(position, childViewHolder)
    }

    private fun swapUsersFullscreenToPreview(
        holder: OpponentsFromCallAdapter.ViewHolder,
        userId: Int
    ) {
        val userInfo: HashMap<String, String> = (session?.userInfo as HashMap<String, String>?)!!
        val userin = userInfo.get("name")
        ...
        val videoTrackFullScreen =
            conversationFragmentCallback?.getVideoTrackMap()?.get(userIdFullScreen)
    ...
    override fun onReceiveHangUpFromUser(
        ...
        // showToast("onReceiveHangUpSession")
