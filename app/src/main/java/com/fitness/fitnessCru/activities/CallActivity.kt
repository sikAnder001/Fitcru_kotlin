...
import com.ennovations.fitcrutrainer.fragments.IncomeCallFragment
import com.ennovations.fitcrutrainer.fragments.VideoConversationFragment
...
import com.fitness.fitnessCru.quickbox.services.MIN_OPPONENT_SIZE
...
class CallActivity : BaseActivity(), IncomeCallFragmentCallbackListener,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(com.fitness.fitnessCru.R.layout.activity_main_quickblox)
        ...
        connectionView = View.inflate(
            this,
            com.fitness.fitnessCru.R.layout.connection_popup,
            null
        ) as LinearLayout

        /*     val userInfo: Map<String, String> = session?.getUserInfo()!!
             userInfo.get("name")
             Hawk.put(NAME,userInfo.get("name"))*/
    }
    ...
    private fun startScreenSharing(data: Intent?) {
        val fragmentByTag =
            supportFragmentManager.findFragmentByTag(ScreenShareFragment::class.simpleName)
        if (fragmentByTag !is ScreenShareFragment) {
            addFragment(
                supportFragmentManager, com.fitness.fitnessCru.R.id.fragment_container,
        ...
        if (isVideoCall && checkPermissions(PERMISSIONS)) {
            if (cam) {
                ...
                com.fitness.fitnessCru.quickbox.utils.showErrorSnackbar(
                    rootView,
                    getString(com.fitness.fitnessCru.R.string.error_permission_video),
                    com.fitness.fitnessCru.R.string.dlg_allow,
            ...
            if (mic) {
                ...
                com.fitness.fitnessCru.quickbox.utils.showErrorSnackbar(
                    rootView,
                    com.fitness.fitnessCru.R.string.error_permission_audio,
                    "Allow Permission",
                    com.fitness.fitnessCru.R.string.dlg_allow,
                    object : View.OnClickListener {
                        override fun onClick(v: View?) {
        ...
        if (callService.currentSessionExist()) {
            ...
            if (supportFragmentManager.findFragmentByTag(INCOME_CALL_FRAGMENT) == null) {
                addFragment(
                    ...
                    com.fitness.fitnessCru.R.id.fragment_container,
                    fragment,
    ...
    private fun addConversationFragment(isIncomingCall: Boolean) {
        ...
        val conversationFragment =
            BaseConversationFragment.newInstance(baseConversationFragment, isIncomingCall)
        addFragment(
            supportFragmentManager,
            com.fitness.fitnessCru.R.id.fragment_container,
    ...
    private fun showConnectionPopUp() {
        runOnUiThread {
            val fragmentContainer: FrameLayout =
                findViewById(com.fitness.fitnessCru.R.id.fragment_container)
            val connectionNotificationView: TextView? =
                connectionView?.findViewById(com.fitness.fitnessCru.R.id.notification)
            connectionNotificationView?.setText(com.fitness.fitnessCru.R.string.connection_was_lost)
    ...
    override fun onStateChanged(
        ...
        sessiontState: BaseSession.QBRTCSessionState?
    ) {
        val userInfo: HashMap<String, String> = (session?.userInfo as HashMap<String, String>?)!!
        val userin = userInfo.get("name")
        val userim = userInfo.get("image")
    ...
    override fun onReceiveHangUpFromUser(
        ...
        /*     val userInfo = session?.userInfo?.let { HashMap<String, String>(it) }
             val userin= userInfo?.get("name")*/

        //  showToast("onReceiveNewSessionCallActivity")
        val userInfo: HashMap<String, String> = (session?.userInfo as HashMap<String, String>?)!!
        ...
        /* val userInfo2: HashMap<String, String> = (session?.userInfo as HashMap<String, String>?)!!
        ...
        //  Log.v("hell", userInfo.get("image").toString())
        if (callService.isCurrentSession(session)) {
            ...
            /*   val participantName =
                if (participant != null) userin else userId.toString()


            shortToast("User " + Hawk.get(NAME) + " " + getString(com.fitness.fitnessCru.R.string.text_status_hang_up) + " conversation")
    ...
    override fun onReceiveNewSession(session: QBRTCSession?) {
        ...
        /* val userInfo = java.util.HashMap<String, String>()
        ...
        /*  val pushBroadcastReceiver = object : BroadcastReceiver() {
              override fun onReceive(context: Context, intent: Intent) {
                // String.format(R.String.text_push_notification_message.toString(),Hawk.get(NAME))*//*
